                    ...
                    <div id="gallery-container">
                        <div class="row gallery-3-columns isotope-x clearfix">
                            <%
                                ...
                                int cou = cb.getMessageCount("select count(*) from bk where fl='"+fl+"' and bt like '%"+bt+"%'");//得到信息总数
                                ...
                                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from bk where fl='"+fl+"'  and bt like '%"+bt+"%' order by id desc ",6);
