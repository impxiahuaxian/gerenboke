...
<%
    ...
    if(admin==null){
        ...
        String id="";String mc="";String dz="";
        if(method.equals("uplj")){
            id=request.getParameter("id");
            List jlist = cb.get1Com("select * from lj where id='"+id+"'",3);
            mc=jlist.get(1).toString();
            dz=jlist.get(2).toString();
        }
%>
<body>
<div class="x-body">
    <form action="<%=basePath%>lj/addMethod" method="post" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="dz" value="<%=dz%>" class="layui-input" required>
            </div>
        </div>
        <div class="layui-form-item">
