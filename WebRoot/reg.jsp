            ...
            <div class="main col-md-9 inner-left" role="main">
                <div class="about-page-wrap">
                    <div id="contact-wrap">
                        ...
                        <form class="add-msg-form" action="<%=basePath%>member/addMember" method="post">
                            <div class="row">
                                ...
                                <div class="cf-column col-md-61">
                                    <input name="username" type="text" placeholder="用户姓名" required/>
                                </div>
                                <div class="cf-column col-md-61">
                                ...
                                <div class="cf-column col-md-61">
                                    <input name="sfz" type="text" placeholder="身份证号" pattern="[0-9]{18}" title="18位号码" required/>
                                </div>
                                <div class="cf-column col-md-61">
                                    <input name="tel" type="text" placeholder="联系电话" pattern="[0-9]{11}" title="11位号码" required/>
                                </div>
                                <div class="cf-column col-md-61">
                                ...
                                <div class="cf-column col-md-12 submit-column">
                                    <center><br/><br/><a href="<%=basePath%>login.jsp">用户登录</a>&nbsp;&nbsp;&nbsp;<a href="<%=basePath%>lost.jsp">忘记密码</a></center>
                                </div>
                            </div>
                        </form>
