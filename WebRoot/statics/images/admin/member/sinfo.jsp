...
<div class="x-body">
    <!--查询-->
    <form class="layui-form x-center" action="<%=basePath%>admin/member/sinfo.jsp" method="post" style="width:100%">
    ...
    <!--列表-->
    <form action="<%=basePath%>member/batchDel" method="post" name="form1">
        <table class="tablelist"  border="1">
            ...
            <%
                ...
                int cou = cb.getMessageCount("select count(*) from member where username like '%"+username+"%' and realname like '%"+realname+"%' ");//得到信息总数
                ...
                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from member where username like '%"+username+"%' and realname like '%"+realname+"%' order by id desc",12);
            ...
            <tr>
                ...
                <td><img src="<%=basePath+pagelist2.get(11).toString()%>" alt="" width="70" height="70" border="0"/></td>
                <td>
                    <a href="<%=basePath%>member/upifuse/<%=pagelist2.get(0).toString()%>">管理</a>
                    <a onclick="if (confirm('确定要删除吗？')) return true; else return false;" href="<%=basePath%>member/del/<%=pagelist2.get(0).toString()%>">删除</a>
                </td>
            </tr>
            <%}}%>
        </table>
