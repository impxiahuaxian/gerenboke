...
<div class="x-body">
    <!--查询-->
    <form class="layui-form x-center" action="<%=basePath%>admin/dd/sinfo.jsp" method="post" style="width:100%">
    ...
    <form action="<%=basePath%>dd/batchDel3" method="post" name="form1">
        <table class="tablelist"  border="1">
            ...
            <%
                ...
                int cou = cb.getMessageCount("select count(*) from dd where bh like '%"+bh+"%' ");//得到信息总数
                ...
                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where bh like '%"+bh+"%' order by id desc",14);
            ...
            <tr>
                ...
                <td>
                    <a href="<%=basePath%>dd/upMethod2?id=<%=pagelist2.get(0).toString()%>">删除评价</a>
                    <a onclick="if (confirm('确定要删除吗？')) return true; else return false;" href="<%=basePath%>dd/del3/<%=pagelist2.get(0).toString()%>">删除</a>
                </td>
            </tr>
            <%}}%>
        </table>
