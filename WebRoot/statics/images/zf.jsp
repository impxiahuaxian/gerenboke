...
<%String fwid=(String)request.getAttribute("fwid");%>
        ...
        <div class="row">
            <div class="main col-md-9 inner-left" role="main">
                <div class="about-page-wrap">
                    <div id="contact-wrap">
                        <h3 class="msg-title">提交订单</h3>
                        <form class="add-msg-form" action="<%=basePath%>dd/addMethod2" method="post">
                            <div class="row"><input type="hidden" name="fwid" value="<%=fwid%>">
                                <div class="cf-column col-md-61">
                                    <input name="sl" type="number" min="1" placeholder="租住月数" required/>
                                </div>
                                <div class="cf-column col-md-61">
                                    <input name="xm" type="text" placeholder="男姓名" required/>
                                </div>
                                <div class="cf-column col-md-61">
                                    <input name="dh" type="text" placeholder="联系电话" required/>
                                </div>
