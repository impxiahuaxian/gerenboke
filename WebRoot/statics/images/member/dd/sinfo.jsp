...
<div class="x-body">
    <!--查询-->
    <form class="layui-form x-center" action="<%=basePath%>member/dd/sinfo.jsp" method="post" style="width:100%">
    ...
    <!--查询-->
    <!--列表-->
    <form action="<%=basePath%>dd/batchDel" method="post" name="form1">
        <table class="tablelist"  border="1">
            ...
            <%
                ...
                int cou = cb.getMessageCount("select count(*) from dd where bh like '%"+bh+"%' and member='"+member+"' ");//得到信息总数
                ...
                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where bh like '%"+bh+"%' and member='"+member+"' order by id desc",14);
            ...
            <tr>
                ...
                <td>
                    <a href="<%=basePath%>member/dd/add.jsp?id=<%=pagelist2.get(0).toString()%>">评价</a>
                    <a onclick="if (confirm('确定要删除吗？')) return true; else return false;" href="<%=basePath%>dd/del/<%=pagelist2.get(0).toString()%>">删除</a>
                </td>
            </tr>
            <%}}%>
        </table>
