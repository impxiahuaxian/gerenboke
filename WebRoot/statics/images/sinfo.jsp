                    ...
                    <div id="gallery-container">
                        <div class="row gallery-3-columns isotope-x clearfix">
                            <%
                                ...
                                int cou = cb.getMessageCount("select count(*) from fw where fl='"+fl+"' and hx='"+hx+"'");//得到信息总数
                                ...
                                List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from fw where fl='"+fl+"' and hx='"+hx+"' order by jg "+px,7);
